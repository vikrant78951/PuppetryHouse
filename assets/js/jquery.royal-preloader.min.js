...
var Royal_Preloader = {
        ...
        _animatePercentage: function (a, b) {
            ...
            a < b && (a++, setTimeout(function () {
                "number" === Royal_Preloader._mode ? Royal_Preloader._show_percentage && Royal_Preloader._percentage.text(a + "%") : "text" === Royal_Preloader._mode ? Royal_Preloader._text_loader_overlay.css("left", a + "%") : (Royal_Preloader._show_percentage && Royal_Preloader._percentage.text(a + "%"),
        ...
        _processQueue     : function () {
            0 !== this._image_queue.length && (this._loaded++, Royal_Preloader._animatePercentage(Royal_Preloader._percentage_loaded, parseInt(100 * (this._loaded / this._total), 10)), this._show_info ? this._animateName(this._image_queue[0].name, this._reQueue) : this._reQueue())
        },
